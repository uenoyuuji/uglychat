// range(0x0300, 0x036f).concat(range(0x20d0, 0x20ff));
// range(0x0300, 0x036f).concat(range(0x20d0, 0x20e1));
const PRECOMPOSED_CHARACTER_CODES = [
        ...
        decorate: function(str, min, max) {
            ...
            str.split('').forEach(function(chr) {
                ...
                for(let i = 0, l = choice(range(min, max)); i < l; i++) {
                    codes[codes.length] = choice(PRECOMPOSED_CHARACTER_CODES);
                }
